...
class AddFrame extends JFrame {
	...
	AddFrame() {
		...
		c = getContentPane();
		c.setLayout(new FlowLayout(FlowLayout.CENTER, 50, 1));
...
//				if(name.matches("^[a-zA-Z_]*$")==false) {	what if you want to throw exception if this condn - char of length 2 to 13 is false
...
//			    if(strM1.matches("^[a-zA-Z]*$")){
				...
				JOptionPane.showMessageDialog(c, "Error: " +e, "Error", JOptionPane.ERROR_MESSAGE);
			}
...
class IncompleteRnoException extends Exception {
	String msg;
	IncompleteRnoException(String msg) {
		this.msg = msg;
	}
}

class CharInRnoException extends Exception {
	String msg;
	CharInRnoException(String msg) {
		this.msg = msg;
	}
}
...
class IncompleteM1Exception extends Exception {
	String msg;
	IncompleteM1Exception(String msg) {
		this.msg = msg;
	}
}
class IncompleteM2Exception extends Exception {
	String msg;
	IncompleteM2Exception(String msg) {
		this.msg = msg;
	}
}
class IncompleteM3Exception extends Exception {
	String msg;
	IncompleteM3Exception(String msg) {
		this.msg = msg;
	}
}
...
class CharInM1Exception extends Exception {
	String msg;
	CharInM1Exception(String msg) {
		this.msg = msg;
	}
}
class CharInM2Exception extends Exception {
	String msg;
	CharInM2Exception(String msg) {
		this.msg = msg;
	}
}
class CharInM3Exception extends Exception {
	String msg;
	CharInM3Exception(String msg) {
		this.msg = msg;
	}
}